package com.oth.springsecurity.springsecurity.security;

import com.oth.springsecurity.springsecurity.security.filters.JwtAuthenticationFilter;
import com.oth.springsecurity.springsecurity.security.filters.JwtAuthorizationFilter;
import com.oth.springsecurity.springsecurity.security.service.UserDetailsServiceSpec;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().cors().configurationSource(request -> corsConfiguration).and()
			.authorizeRequests().antMatchers(SecurityUtil.AUTHORIZED_PATHS).permitAll()
